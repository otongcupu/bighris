                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <div class="input-group-append">
                                <a href="" class="btn btn-primary" data-toggle="modal" data-target="#newCityModal">
                                    Add New City
                                </a>
                            </div>
                        </div>
...
<div class="modal fade" id="newCityModal" tabindex="-1" aria-labelledby="newCityModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('master/city'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" id="code" name="code" placeholder="City Code">
                    </div>
                    <div class="form-group">
