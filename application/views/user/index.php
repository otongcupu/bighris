                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Remain Leave</b> <a class="float-right">12</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Used Leave</b> <a class="float-right">2</a>
                                </li>
                            </ul>
                        </div>
                        <!-- /.card-body -->
                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#history" data-toggle="tab">History Annual Leave</a></li>
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
