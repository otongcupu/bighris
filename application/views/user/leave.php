                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="cutitahunan" name="leave">
                            <label class="form-check-label">Cuti Tahunan</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="cutikhusus" name="leave" c>
                            <label class="form-check-label">Cuti Khusus</label>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="sakit" name="leave">
                        <label class="form-check-label">Sakit</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="ctd" name="leave">
                        <label class="form-check-label">Cuti Tidak Dibayar (Izin)</label>
                    </div>
                </div>
            </div>
            <div class="form-group row">
